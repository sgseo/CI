...
<body>
<div style='margin:1px auto;width:67%;'>
<!-- 项目录入 -->
<form  style="padding-top:2px; border:1px solid #dddddd" action="/index.php/Home/Menu/add" method="post" enctype="multipart/form-data" >
<!-- 基础文档模型 -->
