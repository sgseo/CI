...
<form class="form-inline definewidth m20" action="/index.php/Home/Role" method="post">  
    客户姓名：
    <input type="text" name="cstname"   class="abc input-default" placeholder="搜索客户姓名" value="">&nbsp;&nbsp;  

    <button type="submit" class="btn btn-primary">查询</button>&nbsp;&nbsp; 
    <!-- <a href="/index.php/Home/Role/cl_to_excel" class="btn btn-success" id="addnew">下载</a>  -->
</form>
        <!-- 我的个人信息开始 -->
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
     ...
     <!--        <td><?php if($vo["address"] != null): echo ($vo["address"]); else: ?>-<?php endif; ?></td>
            ...
            <!-- <td><?php if($vo["status"] != 5): ?><span class='confirm'><a href='/index.php/Home/Role/taskconfirm?taskid=<?php echo ($vo["id"]); ?>&uid=<?php echo ($uid); ?>'>已完成</a></span><?php else: ?>-<?php endif; ?></td> -->
