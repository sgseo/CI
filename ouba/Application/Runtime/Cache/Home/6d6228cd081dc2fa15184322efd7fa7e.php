  ...
  <li class="active">财务审批</li>
    ...
    <tr>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
            <?php echo ($vo["checksec"]); ?>
            </td>
            <td>
              <?php if(($vo["status"]) == "10"): ?><a href='/index.php/Home/Node/loan?id=<?php echo ($vo["id"]); ?>'>去放款</a><?php endif; ?>
            <?php if(($vo["status"]) == "9"): ?><a href='/index.php/Home/Node/loan?id=<?php echo ($vo["id"]); ?>'>去放款</a><?php endif; ?>
            </td>
