...
function showChineseAmount(v,i) {
  ...
  }else
  {
    ...
    <div class="form-inline definewidth m20">角色列表 &nbsp;</div>
...
<form class="form-inline definewidth m20" action="/index.php/Home/Role/indexlist" method="post">  

    角色名字：
    <input type="text" name="username"   class="abc input-default" placeholder="搜索角色名字" value="">&nbsp;&nbsp;  

    <button type="submit" class="btn btn-primary">查询</button>&nbsp;&nbsp; 
    <a href="/index.php/Home/Role/index" class="btn btn-success" id="addnew">添加角色</a> 
</form>
        <!-- 我的个人信息开始 -->
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["ocstatus"]); ?></td>
            <td><?php echo ($vo["username"]); ?></td>
            <td><?php echo ($vo["mobile"]); ?></td>
            <td><?php echo ($vo["hukou"]); ?></td>
