...
<!--     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
    ...
    <a href='/index.php/Home/Role/allotlist?status=1' class="btn btn-primary">刚录入</a>
    <a href='/index.php/Home/Role/allotlist?status=2' class="btn btn-primary">已通过(未分配)</a>
    <a href='/index.php/Home/Role/allotlist?status=3' class="btn btn-primary">已拒绝</a> -->
<form class="form-inline definewidth m20" action="/index.php/Home/Role/allotlist" method="post">  
    借款人：
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
            ...
            <td><a href='/index.php/Home/Role/processdetail?id=<?php echo ($vo["id"]); ?>'><?php echo ($vo["title"]); ?></a></td>
        ...
        <tr>
            <td><b>现场调查</b></td><td><?php if(($vo["xcdc"]) != "0"): ?>标记<?php endif; if(($vo["xcdc"]) == "0"): ?><span style='color:red'>未标记</span><?php endif; ?></td>
            <td><b>强制公证</b></td><td><?php if(($vo["qzgz"]) != "0"): ?>通过<?php endif; if(($vo["qzgz"]) == "0"): ?><span style='color:red'>未通过<?php endif; ?></td>
            <td><b>全委公证</b></td><td><?php if(($vo["qwgz"]) != "0"): ?>通过<?php endif; if(($vo["qwgz"]) == "0"): ?><span style='color:red'>未通过<?php endif; ?></td>
            <td><b>房产抵押</b></td><td colspan='2'><?php if(($vo["fcdy"]) != "0"): ?>标记<?php endif; if(($vo["fcdy"]) == "0"): ?><span style='color:red'>未标记<?php endif; ?></td>
...
<script type='text/javascript'>
    $("select[name=salesman]").change(function(){
        ...
        $.ajax({
            type:"get",
            url:"/index.php/Home/Role/allocated",
