...
<div class="every_p">
<span>房龄(年):</span>
<input type="text" class="width_321"  name="houseage" value="<?php echo ($returndata["area"]); ?>" >
</div>
...
<div class='title_p'><span>风控初审意见</span></div>
 ...
 <div class='every_p'>
  <span>初审意见:</span>
  <input type="text" value='<?php echo ($returndata["tip"]); ?>' name='tip'  />
  </div>
...
<div class="clear"></div>
<div class="sidebar-frame">  
<div class='title_p'><span>合同打印</span></div>
  <div class='every_p'>
<span>合同类型: </span>
<!-- <input type="text" class="width_353"   maxlength='20' readonly='readonly'/> -->
</div>
<div class='every_p'>
<span> </span>
<!-- <input type="text" class="width_353"  id='account' maxlength='20' readonly='readonly'/> -->
...
<div class='every_p'>
<span><a href='/index.php/Home/Menu/contract?id=<?php echo ($returndata["id"]); ?>'>打印</a> </span>
</div>  
<div class='every_p'>
<span>抵押合同: </span>
</div>
...
<div class='every_p'>
<span><a href='/index.php/Home/Menu/peldge?id=<?php echo ($returndata["id"]); ?>'>打印</a> </span>
</div>
...
<div class='every_p'>
<span><a href='/index.php/Home/Menu/threes?id=<?php echo ($returndata["id"]); ?>'>打印</a></span>
...
<div class="sidebar-frame" style='margin:10px auto;border:none'> 
  <div class="sidebar-s"> 
    <a  href='/index.php/Home/Menu/printer' class="btn btn-large btn-primary btn btn-default"  style='margin:10px 10px;'/>返回</a>
    </div>
</div>
