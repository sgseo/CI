...
function showChineseAmount(v,i) {
  ...
  <!-- <li >十一月</li> -->
    ...
    <div class="form-inline definewidth m20">借款项目列表 &nbsp;</div>
<form class="form-inline definewidth m20" action="/index.php/Home/Menu/admitshow" method="post">  
    搜索标题：
    <input type="text" name="title"   class="abc input-default" placeholder="搜索借款标题" value="">&nbsp;&nbsp;  
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                <!-- <span onclick='del(<?php echo ($vo["id"]); ?>);' style='color:#0088cc;cursor:pointer'>审批</span> -->

                <a href='/index.php/Home/Menu/admitfuck?id=<?php echo ($vo["id"]); ?>'>审批</a>
            </td>
        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
    <!-- // /index.php/Home/Menu/admit?id=<?php echo ($vo["id"]); ?> -->
    </table>
     <!-- 我的个人信息结束 -->
     <div class='page'>
          <?php echo ($page); ?>
