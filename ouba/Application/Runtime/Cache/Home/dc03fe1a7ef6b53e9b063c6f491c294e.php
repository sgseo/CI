...
<!-- <form class="form-inline definewidth m20" action="/index.php/Home/Role/managelist" method="post">  
    机构名字：
  ...
  <!-- <button type="submit" class="btn btn-primary">添加机构</button>&nbsp;&nbsp;  -->
   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; <a href="/index.php/Home/Role/manage" class="btn btn-success" >添加机构</a> 
        <!-- 我的个人信息开始 -->
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["oxz"]); ?></td>
            <td><?php echo ($vo["organization"]); ?></td>
            <td><?php echo ($vo["shortname"]); ?></td>
            <td><?php echo ($vo["contactname"]); ?></td>
            <td><?php echo ($vo["bankaccountname"]); ?></td>
            <td><img src="/Uploads<?php echo ($vo["licensepic"]); ?>" alt="" class='img-circle' width='100px' height='30px'></td>
