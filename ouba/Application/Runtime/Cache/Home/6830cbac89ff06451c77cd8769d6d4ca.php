...
function showChineseAmount(v,i) {
  ...
  }else
  {
   ...
   <!--  <div class="form-inline definewidth m20">已完成项目列表 &nbsp;</div>
...
<form class="form-inline definewidth m20" action="/index.php/Home/User" method="post">  
    借款人：
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                <?php if(($vo["category"]) == "car"): ?>车抵押&nbsp;<!--<input type="button" value="&nabla;" onclick="demo08(<?php echo ($vo["id"]); ?>);" />--><?php endif; ?>
                <?php if(($vo["category"]) == "fang"): ?>房抵押&nbsp;<!--<input type="button" value="&nabla;" onclick="demo08(<?php echo ($vo["id"]); ?>);" />--><?php endif; ?>
            </td>
 ...
 if($vo['capitalsource']==session('pid')) { ?>
                   <a href="/index.php/Home/User/loanreturn?id=<?php echo ($vo["id"]); ?>&respid=<?php echo ($vo["respid"]); ?>">还款</a>
                   <?php
 }else{ echo "-"; } ?>
            </td>
