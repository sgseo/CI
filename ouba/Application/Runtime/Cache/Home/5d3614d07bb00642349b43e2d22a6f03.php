...
<body>
    <script type="text/javascript">
        ...
        function demo08(id) {
             jBox.open("get:/index.php/Home/User/impawn?id="+id, title, 300, 50, { buttons: { '关闭': true }, persistent: false });
        }
     ...
     function del(id)
        {
            ...
            var submit = function (v, h, f) {
                if (f.yourtip == '') {
                 ...
                 $.ajax({
                             type: "POST",
                             url: "/index.php/Home/User/admityj",
                             data: {id:id,f:f.yourtip,s:3},
                             dataType: "json",
                             success: function(data){
                                        if(data==1)
                                          { 
                                            location.href = '/index.php/Home/User/admit?id='+id;
                                          }else{
...
<ol class="breadcrumb">
  ...
  <li class="active">贷款列表</li>
    ...
    <div class="form-inline definewidth m20">贷款列表 &nbsp;</div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     
<form class="form-inline definewidth m20" action="/index.php/Home/User/end" method="post"> 
<a href='/index.php/home/menu/index' class="btn btn-primary">贷款录入</a> 
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
            <?php echo ($vo["status"]); ?>
            <!--     <?php if($vo['status']==2) { echo '待分配'; }else if($vo['status']==3){ echo '已拒绝'; }else if($vo['status']==4) { echo "已分配"; }else if($vo['status']==5) { echo "已处理"; }else if($vo['status']==6) { echo "已放款"; }else if($vo['status']==7) { echo '已完成'; } ?> -->
            </td>
          <!--   <td>
                   <a href="/index.php/Home/User/loanreturn?id=<?php echo ($vo["id"]); ?>">还款</a>
            </td> -->
