...
<ol class="breadcrumb">
  <li><a href="#">业务管理-></a></li>
  <li class="active">打印合同</li>
</ol>
    <div class="form-inline definewidth m20">打印合同 &nbsp;</div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><a href='/index.php/Home/Menu/printerdetail?id=<?php echo ($vo["id"]); ?>'><?php echo ($vo["title"]); ?></a></td>
            ...
            <td><?php echo ($vo["pledgename"]); ?></td>
            <td><?php echo ($vo["ostatus"]); ?></td>
            <td><a href='/index.php/Home/Menu/contract?id=<?php echo ($vo["id"]); ?>'>预览合同</a><!-- &nbsp;&nbsp;&nbsp;<a href='javascript:void(0);' >打印</a> --></td>
            <td><a href='/index.php/Home/Menu/peldge?id=<?php echo ($vo["id"]); ?>'>预览合同</a></td>
            <td><a href='/index.php/Home/Menu/threes?id=<?php echo ($vo["id"]); ?>'>预览合同</a></td>
