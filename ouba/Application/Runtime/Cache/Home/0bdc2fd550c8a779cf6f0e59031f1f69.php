...
<ol class="breadcrumb">
  <li><a href="#">业务管理-></a></li>
  <li class="active">贷款分配</li>
</ol>
    <div class="form-inline definewidth m20">贷款分配列表 &nbsp;</div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
<!--     <a href='/index.php/Home/Menu/allotlist?status=4' class="btn btn-primary">已分配</a>
    <a href='/index.php/Home/Menu/allotlist?status=1' class="btn btn-primary">刚录入</a>
    <a href='/index.php/Home/Menu/allotlist?status=2' class="btn btn-primary">已通过(未分配)</a>
    <a href='/index.php/Home/Menu/allotlist?status=3' class="btn btn-primary">已拒绝</a> -->
<form class="form-inline definewidth m20" action="/index.php/Home/Menu/allotlist" method="post">  
    借款人：
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
            ...
            <td><?php echo ($vo["username"]); ?></td>
                  <td>
                <?php if(($vo["username"]) == ""): ?><select name="salesman" id='<?php echo ($k); ?>'>
                    <option value="-1">请选择业务员</option>
                    <?php if(is_array($salesman)): $i = 0; $__LIST__ = $salesman;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sa): $mod = ($i % 2 );++$i;?><option value="<?php echo ($sa["id"]); ?>" data-pro='<?php echo ($vo["id"]); ?>'><?php echo ($sa["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                 </select><?php endif; ?>
             </td>
...
<script type='text/javascript'>
    $("select[name=salesman]").change(function(){
        ...
        $.ajax({
            type:"get",
            url:"/index.php/Home/Menu/allocated",
