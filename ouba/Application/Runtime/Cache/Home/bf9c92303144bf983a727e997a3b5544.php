...
<form class="form-inline definewidth m20" action="/index.php/Home/Menu/showlist" method="post">  
    借款人：
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                <?php if(($vo["status"]) < "5"): ?><a href='/index.php/Home/Menu/modifyshow?id=<?php echo ($vo["id"]); ?>'>修改</a><?php endif; ?>
              <!--   <?php if($vo["status"] == 1): ?><a href='/index.php/Home/Menu/modifyshow?id=<?php echo ($vo["id"]); ?>'>修改</a>
                <span class='confirm'>
                <a href='/index.php/Home/Menu/del?id=<?php echo ($vo["id"]); ?>'>删除</a>
                </span><?php endif; ?> -->
            </td>
