...
class wxcurl{
    ...
    public static  $pname = 'm';

    //授权账号
    public static  $url   = WX_URL_access_token;

    //key值
    public static  $key   = '4e7d42a132e154cf6813aef44367402c';
     ...
     */
    public static function curl_send($url,$post_data='',$timeout=6,$headers=array(),$crt_path=false){
        $ch = curl_init();
        ...
        if($crt_path){
            curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);  //关闭安全链接
