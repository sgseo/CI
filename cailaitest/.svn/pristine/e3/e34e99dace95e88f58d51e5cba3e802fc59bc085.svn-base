...
return array(
	...
	'WEB_URL'=>"https://".$_SERVER['HTTP_HOST'],//网站域名,2015-3-2号http改为https           by whh 
	...
	//数据库配置
	'DB_TYPE'           => 'mysql',
	'DB_HOST'           => '115.29.245.207',//'192.168.0.118',
	'DB_NAME'           =>'cailainew',
	'DB_USER'           =>'test',
	'DB_PWD'            =>'cailai1234567890',
	'DB_PORT'           =>'3306',
	'DB_PREFIX'         =>'lzh_',
	...
	'URL_ROUTE_RULES'	=>array(
        ...
        '/^invest\/(\d+)a.html$/' => 'Home/invest/newbie?id=:1',//新手标详细
        ...
        '/about\/(\d+).html$/' => 'Home/about/college?id=:2',//文章内容页
