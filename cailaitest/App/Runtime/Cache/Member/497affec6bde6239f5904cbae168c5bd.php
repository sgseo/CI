...
<div class="cz" style="width: 705px;margin:30px 0 30px 35px;padding:18px 13px 18px 12px; border:1px #eaeaea solid;">
	...
	<dl style="padding-top:10px">
		...
		<dd style="width:500px;"><input type="text"  readonly='readonly' value='<?php echo (($totalmoney)?($totalmoney):"0.00"); ?>' class="input_money" >&nbsp;&nbsp;元&nbsp;&nbsp; 
         </dd>
	</dl>
	<dl style="padding-top:10px;">
	...
	<dl>
		<div style="text-align:center; width: 61%;">
                    <?php if($hasbind == 0): ?><input class="submit zw" id="bank_submit" type="submit" value="">
                     <?php else: ?>
                       <input class="submit" id="bank_submit" type="submit" value=""><?php endif; ?>  
 		</div>
	</dl>
	</form>
...
<div style="float:left; display:inline; width:680px; margin-left:5px; font-size:16px; color:#f35a00;line-height:28px;" >温馨提示</div>
