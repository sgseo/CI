    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td valign="top">
            ...
            <dl class="lx"><dt>实名认证会员总数:</dt><dd><?php echo ($list["mm"]["ms_id"]); ?>人</dd></dl>
            <dl class="lx"><dt>通过手机认证:</dt><dd><?php echo ($list["mm"]["ms_phone"]); ?>人</dd></dl>
            <dl class="lx"><dt>已绑卡会员总数:</dt><dd><?php echo ($list["mm"]["ms_mb"]); ?>人</dd></dl>
            <!-- <dl class="lx"><dt>下载APP总数:</dt><dd><?php echo ($list["mm"]["ms_video"]); ?>人</dd></dl> -->
            <dl class="lx"><dt>推荐人数:</dt><dd><?php echo ($list["mm"]["ms_renum"]); ?>人</dd></dl>
        </td>
      </tr>
    </table>
  </div>
