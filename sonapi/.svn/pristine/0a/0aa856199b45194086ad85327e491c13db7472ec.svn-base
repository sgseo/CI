...
class remote {
	...
	public static  $pname = 'android';

	//授权账号
	public static  $url   = 'http://apitest.cailai.com/v1.0/';

	//key值
	public static  $key   = 'b2c64c62eed5be491b993e88bef95a52';
	...
	public static function reset(){
		...
		self::$key = 'b15dd36e3831e929f968d1f45cceca3c';
		self::$timeout = 5;
	}
