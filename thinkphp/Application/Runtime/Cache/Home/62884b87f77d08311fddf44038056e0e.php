...
<script type='text/javascript'>
    function send(phone)
    {
            ...
            if(pat.test(str))
            {
               $.ajax({
                    type: "post",
                    url: "/thinkphp/Home/Role/sendsms",
                    dataType: "json",
...
<body>
<!-- <form class="form-inline definewidth m20" action="/thinkphp/Home/Role/remember?userId=123487&real_name=%E8%8C%83%E4%BB%A5%E5%BD%A4&phone=13300000001" method="post">  
    我推荐的人员列表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    推荐者手机：
...
<table class="table table-bordered table-hover definewidth m10" >
    <thead>
        ...
        <th>发送短信提醒</th>
         ...
         <tr>
            ...
            <td><button type="button" class="btn btn-success" id='sendSMS' onclick="send(<?php echo ($phone); ?>)">提醒</button></td>
        </tr>
   ...
   -->
    ...
    <div class='table table-bordered table-hover definewidth m10' style='margin:0 auto;text-align:center;'>
           <?php for($i=1;$i<=$total;$i++) { echo "<a href='/thinkphp/Home/Role/remember?userId=$condi&real_name=$real_name&p=$i'>"."第".$i.'页</a>&nbsp;&nbsp;'; } $p=$p?$p:1;$total=$total?$total:1; echo "当前第<span style='color:red'>&nbsp;".$p.'&nbsp;</span>页'."共".$total."页"; ?>
    </div>
		</body>
		</html>