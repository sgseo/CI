...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <!-- 我的投资记录开始 -->
   <div class="form-inline definewidth m20">我的投资记录：<a class="btn btn-success" href="/channel/Home/Node/invest_record">导出excel</a></div>
    <table class="table table-bordered table-hover definewidth m10" >
    <thead>
    <tr>
        <th>借款标号</th>
  ...
  <div class='table table-bordered table-hover definewidth m10' style='margin:0 auto;text-align:center;'>
           <?php for($i=1;$i<=$total;$i++) { echo "<a href='/channel/Home/Node/?p=$i&dp=$dp'>"."第".$i.'页</a>&nbsp;&nbsp;'; } $p=$p?$p:1;$total=$total?$total:1; echo "当前第<span style='color:red'>&nbsp;".$p.'&nbsp;</span>页'."&nbsp;&there4;投资记录共".$total."页"; ?>
        </div>
        <!-- 我的投资记录结束-->

        <!-- 个人流水开始 -->

         <div class="form-inline definewidth m20">我的交易记录：<a class="btn btn-success" href="/channel/Home/Node/deal_record">导出excel</a></div>
    <table class="table table-bordered table-hover definewidth m10" >
    <thead>
    <tr>
        <th>交易时间</th>
  ...
  <div class='table table-bordered table-hover definewidth m10' style='margin:0 auto;text-align:center;'>
           <?php for($i=1;$i<=$dtotal;$i++) { echo "<a href='/channel/Home/Node/?p=$p&dp=$i'>"."第".$i.'页</a>&nbsp;&nbsp;'; } $dp=$dp?$dp:1;$total=$dtotal?$dtotal:1; echo "当前第<span style='color:red'>&nbsp;".$dp.'&nbsp;</span>页'."&nbsp;&there4;交易记录共".$dtotal."页"; ?>
        </div>
        <!-- 个人流水结束 -->
